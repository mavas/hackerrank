...
me with a slightly more complex example of your programming. Consider the
following problem: Given an array of positive integers, return the greatest
possible product among any two integers in the array. I.e. find a[i] * a[j]
such that i != j and a[i] * a[j] is the greatest possible. What would your
